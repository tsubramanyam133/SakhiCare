...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-[calc(100dvh-5rem)] flex items-center justify-center p-4 overflow-hidden bg-gradient-to-br from-pink-50 via-rose-50 to-pink-100/50">
